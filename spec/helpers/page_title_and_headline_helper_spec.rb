...
describe PageTitleAndHeadlineHelper do
  describe '#headline_with_flash' do
    describe 'no params given' do
      ...
      it { should have_content 'About PIMP Editor' }
    end
  ...
  describe '#title_tag' do
    ...
    context 'on other path' do
      ...
      it { should eq '<title>This is the title - PIMP Editor</title>' }
    end
    ...
    context 'with flash' do
      ...
      it { should eq '<title>Alert: This is an alert! Notice: This is a notice! This is the title - PIMP Editor</title>' }
    end
  end
end
