...
- Replace all occurrences of <code>Pimp::Application</code> with <code>PROJECT::Application</code> (e.g. <code>PrettyCalc::Application</code>) and every occurrence of <code>Module Pimp</code> with <code>Module PROJECT</code> (e.g. <code>Module PrettyCalc</code>)
